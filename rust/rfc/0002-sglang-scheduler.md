...
**Status:** draft (from branch `rust-scheduler`, where it ships behind
`SGLANG_RUST_SCHEDULER=planner|core|stream`)
**Depends on:** RFC 0001 (`sglang-radix`) for the admission tree.
